...
// Adapted by Rick Rutt from alice.tuprologx.ide.JavaIDE
// to allow access to embedded Prolog engine.
// JavaIDE license header follows:
...
public class NewsGogglesIde extends JFrame implements IDE {
    ...
    public NewsGogglesIde() {
        super("News Goggles IDE - Using tuProlog");
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        System.out.println("Using tuProlog system - release " + Prolog.getVersion());
